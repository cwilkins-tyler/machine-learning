...
class Simulator(object):
    ...
    def render(self, trial, testing=False):
        ...
        self.pygame.draw.rect(self.screen, self.boundary, ((self.env.bounds[0] - self.env.hang) * self.env.block_size,
            ...
            self.env.bounds[2] + self.env.hang / 3) * self.env.block_size, (self.env.bounds[
        ...
        for intersection, traffic_light in self.env.intersections.items():
            self.pygame.draw.circle(self.screen, self.road_color, (intersection[0] * self.env.block_size,
